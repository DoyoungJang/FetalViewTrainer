...
## Anatomy registration correction

Limb planes now use reference points inspected against orthographic and oblique renders of the actual curled gelmi surface, including distal ankles and toes at the front of the pose. These are surface/joint reference locations, not segmented ulna/radius or tibia/fibula. DHARANI posterior-inferior cerebellar-region references and a thalamic-region reference replace the old brainstem-level plane; these are visually registered regions, not clinically validated tissue labels. The authored fetal upper-vessel paths and 3VV/3VT planes now share one landmark definition: PA–Ao–SVC ordering, smaller SVC caliber, and two arches converging left of the trachea. The HRA adult 3VV uses a common level intersecting all three vessel meshes, while its PA measurement plane uses the local pulmonary-trunk centerline. Source guidance: ISUOG fetal cardiac screening 2023 pp. 794–796; ISUOG CNS screening 2020 transcerebellar plane; ISUOG Basic Training longitudinal limb planes 16–17. No registration is asserted to be a validated clinical acquisition plane.
