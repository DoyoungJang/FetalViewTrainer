...
let code=await readFile('dist/app.js','utf8');code=code.replace("import {renderUltrasound} from './ultrasound.js?v=25';",'').replace("import {phases,sources} from './data.js?v=25';",'').replace("import {drawExtra} from './extra-diagrams.js?v=25';",'').replace(/setup3D\(\)\.catch\(\(\)=>\{.*?\}\);/s,'');vm.runInNewContext(code,sandbox);
