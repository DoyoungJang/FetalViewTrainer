...
let code=await readFile('dist/app.js','utf8');code=code.replace("import {phases,sources} from './data.js?v=17';",'').replace("import {drawExtra} from './extra-diagrams.js?v=17';",'').replace(/setup3D\(\)\.catch\(\(\)=>\{.*?\}\);/s,'');vm.runInNewContext(code,sandbox);
